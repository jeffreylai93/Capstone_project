...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
       ...
       # return the outcomes piechart for a selected site
        filtered_df = spacex_df[spacex_df['Launch Site'] == entered_site].groupby(['class']). \
...
def get_scatter_chart(entered_site, payload_slider):
    ...
    if entered_site == 'ALL':
        ...
        filtered_df_1 = filtered_df[filtered_df['Launch Site'] == entered_site]   
        fig = px.scatter(filtered_df_1, x= 'Payload Mass (kg)', y ='class',
        color="Booster Version Category",
